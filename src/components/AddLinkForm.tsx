	...
	return (
		<section className="w-full rounded-2xl border border-black/8 bg-white p-6 dark:border-white/[.145] dark:bg-black">
			...
			<input
				...
				placeholder="https://..."
				className="mt-2 w-full rounded-xl border border-black/8 bg-transparent px-4 py-3 text-sm text-black outline-none focus:ring-2 focus:ring-black/10 dark:border-white/[.145] dark:text-zinc-50 dark:focus:ring-white/20"
				autoComplete="off"
				autoCapitalize="none"
				autoCorrect="off"
				spellCheck={false}
			...
			<div className="mt-4 flex items-center gap-4 rounded-2xl border border-black/8 p-4 dark:border-white/[.145]">
